...
namespace WebStore1p.Data
{
    public class TestData
    {
        ...
        public static IEnumerable<Section> Sections { get; } = new[]
        {
            ...
            new Section{ Id = 8, Name = "Fendi", Order = 2, ParentId = 7},
            new Section{ Id = 9, Name = "Guess", Order = 3, ParentId = 7},
            new Section{ Id = 10, Name = "Valentino", Order = 4, ParentId = 7},
            new Section{ Id = 11, Name = "Диор", Order = 5, ParentId = 7},
            new Section{ Id = 12, Name = "Версачи", Order = 6, ParentId = 7},
            new Section{ Id = 13, Name = "Армани", Order = 7, ParentId = 7},
            new Section{ Id = 14, Name = "Prada", Order = 8, ParentId = 7},
            new Section{ Id = 15, Name = "Дольче и Габбана", Order = 9, ParentId = 7},
            new Section{ Id = 16, Name = "Шанель", Order = 10, ParentId = 7},
            new Section{ Id = 17, Name = "Гуччи", Order = 11, ParentId = 7},
